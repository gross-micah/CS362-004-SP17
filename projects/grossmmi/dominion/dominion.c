...
//assignment 2 functionality for 5 cards
void adventurerM(int currentPlayer, int *cardDrawn, int *drawntreasure, int* temphand, int* z, struct gameState *state)
{
  ...
  while(*z-1>=0){
    int temp = *z - 1;
    state->discard[currentPlayer][state->discardCount[currentPlayer]++]=temphand[temp]; // discard all cards in play that have been drawn
    *z = temp;
  }
}
...
void villageM(int currentPlayer, int handPos, struct gameState *state)
{
  //+1 Card
  drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  */
    ...
    /*
      ...
      discardCard(handPos, currentPlayer, state, 0);
      */
      villageM(currentPlayer, handPos, state);
      return 0;
    ...
    /*
      ...
      discardCard(handPos, currentPlayer, state, 0);
      */
      great_hallM(currentPlayer, handPos, state);
      return 0;
